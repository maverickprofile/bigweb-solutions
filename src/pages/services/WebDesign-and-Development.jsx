    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-6">
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-6xl font-extrabold mt-10 mb-2 leading-tight"
        >
        ...
        <motion.p
          ...
          className="text-lg sm:text-xl max-w-2xl lg:mx-auto text-white/90"
        >
        ...
        >
          <Link to="/contact" className="relative z-10">
            <button className="lg:mt-8 mb-10 mt-1 bg-white px-8 py-3 rounded-full font-bold hover:bg-gray-100 transition">
  ...
  <div className="whitespace-nowrap animate-marqueeLeft flex gap-4 py-2">
    {Array(2)
      ...
      .map((service, index) => (
        ...
        >
          <span className="text-[#7A63F5]">{service.icon}</span>
    ...
    {Array(2)
      ...
      .map((service, index) => (
        <div
          ...
          className="inline-flex items-center bg-white/10 backdrop-blur-md border border-white/20 text-white px-6 py-2 rounded-2xl shadow text-sm font-semibold gap-2"
        >
          <span className="text-[#159BF0]">{service.icon}</span>
          <span>{service.label}</span>
        </div>
      ))}
  </div>
